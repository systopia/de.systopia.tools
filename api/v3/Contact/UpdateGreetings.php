...
/**
 * Update greetings for the given contacts
 * @param $specs array API specs
 */
function _civicrm_api3_contact_update_greetings_spec(&$specs) {
 ...
 * @return array result
 */
function civicrm_api3_contact_update_greetings($params) {
